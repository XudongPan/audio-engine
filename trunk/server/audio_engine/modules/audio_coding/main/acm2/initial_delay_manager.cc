...
void InitialDelayManager::UpdateLastReceivedPacket(
  ...
  // Just shorthands.
  const AudioPacketHeader* current_header = &rtp_info.header;
  AudioPacketHeader* last_header = &last_packet_rtp_info_.header;
...
void InitialDelayManager::UpdatePlayoutTimestamp(
    const AudioPacketHeader& current_header, int sample_rate_hz) {
