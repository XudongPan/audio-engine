...
namespace RTCPUtility {
    ...
    struct RTCPPacketXRwebrtcMetricItem
    {
        // RFC 3611 4.7
        uint32_t    SSRC;
        uint8_t     lossRate;
    ...
    union RTCPPacket
    {
        ...
        RTCPPacketXRwebrtcMetricItem XRwebrtcMetricItem;
    ...
    private:
        ...
        bool ParseXrwebrtcMetricItem(int block_length_4bytes);
