...
void VoipVad_Downsampling(int16_t* signal_in,
  ...
  for (n = 0; n < half_length; n++) {
    ...
    tmp16_1 = (int16_t) ((tmp32_1 >> 1) +
        VOIP_SPL_MUL_16_16_RSFT(kAllPassCoefsQ13[0], *signal_in, 14));
    *signal_out = tmp16_1;
    tmp32_1 = (int32_t) (*signal_in++) -
        VOIP_SPL_MUL_16_16_RSFT(kAllPassCoefsQ13[0], tmp16_1, 12);

    // All-pass filtering lower branch.
    tmp16_2 = (int16_t) ((tmp32_2 >> 1) +
        VOIP_SPL_MUL_16_16_RSFT(kAllPassCoefsQ13[1], *signal_in, 14));
    *signal_out++ += tmp16_2;
    tmp32_2 = (int32_t) (*signal_in++) -
        VOIP_SPL_MUL_16_16_RSFT(kAllPassCoefsQ13[1], tmp16_2, 12);
  }
...
int16_t VoipVad_FindMinimum(VadInstT* self,
  ...
  tmp32 = VOIP_SPL_MUL_16_16(alpha + 1, self->mean_value[channel]);
  tmp32 += VOIP_SPL_MUL_16_16(VOIP_SPL_WORD16_MAX - alpha, current_median);
  tmp32 += 16384;
