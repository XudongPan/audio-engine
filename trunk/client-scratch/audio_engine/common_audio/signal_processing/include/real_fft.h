#ifndef VOIP_COMMON_AUDIO_SIGNAL_PROCESSING_INCLUDE_REAL_FFT_H_
#define VOIP_COMMON_AUDIO_SIGNAL_PROCESSING_INCLUDE_REAL_FFT_H_

#include "audio_engine/include/typedefs.h"

// For ComplexFFT(), the maximum fft order is 10;
// for OpenMax FFT in ARM, it is 12;
// VoIP APM uses orders of only 7 and 8.
...
extern CreateRealFFT VoipSpl_CreateRealFFT;
extern FreeRealFFT VoipSpl_FreeRealFFT;
extern RealForwardFFT VoipSpl_RealForwardFFT;
extern RealInverseFFT VoipSpl_RealInverseFFT;
...
// function with VoIPSpl_CreateRealFFT().
...
// FFT function with VoipSpl_CreateRealFFT().
...
#endif  // VOIP_COMMON_AUDIO_SIGNAL_PROCESSING_INCLUDE_REAL_FFT_H_
