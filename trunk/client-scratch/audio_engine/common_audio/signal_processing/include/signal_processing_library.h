 ...
 */
#ifndef VOIP_SPL_SIGNAL_PROCESSING_LIBRARY_H_
#define VOIP_SPL_SIGNAL_PROCESSING_LIBRARY_H_

#include <string.h>
#include "audio_engine/include/typedefs.h"

// Macros specific for the fixed point implementation
#define VOIP_SPL_WORD16_MAX       32767
#define VOIP_SPL_WORD16_MIN       -32768
#define VOIP_SPL_WORD32_MAX       (int32_t)0x7fffffff
#define VOIP_SPL_WORD32_MIN       (int32_t)0x80000000
#define VOIP_SPL_MAX_LPC_ORDER    14
#define VOIP_SPL_MAX_SEED_USED    0x80000000L
#define VOIP_SPL_MIN(A, B)        (A < B ? A : B)  // Get min value
#define VOIP_SPL_MAX(A, B)        (A > B ? A : B)  // Get max value
// TODO(kma/bjorn): For the next two macros, investigate how to correct the code
// for inputs of a = VOIP_SPL_WORD16_MIN or VOIP_SPL_WORD32_MIN.
#define VOIP_SPL_ABS_W16(a) \
    (((int16_t)a >= 0) ? ((int16_t)a) : -((int16_t)a))
#define VOIP_SPL_ABS_W32(a) \
    (((int32_t)a >= 0) ? ((int32_t)a) : -((int32_t)a))

#ifdef VOIP_ARCH_LITTLE_ENDIAN
#define VOIP_SPL_GET_BYTE(a, nr)  (((int8_t *)a)[nr])
#define VOIP_SPL_SET_BYTE(d_ptr, val, index) \
    (((int8_t *)d_ptr)[index] = (val))
#else
#define VOIP_SPL_GET_BYTE(a, nr) \
...
#define VOIP_SPL_MUL(a, b) \
    ((int32_t) ((int32_t)(a) * (int32_t)(b)))
#define VOIP_SPL_UMUL(a, b) \
    ((uint32_t) ((uint32_t)(a) * (uint32_t)(b)))
#define VOIP_SPL_UMUL_RSFT16(a, b) \
    ((uint32_t) ((uint32_t)(a) * (uint32_t)(b)) >> 16)
#define VOIP_SPL_UMUL_16_16(a, b) \
    ((uint32_t) (uint16_t)(a) * (uint16_t)(b))
#define VOIP_SPL_UMUL_16_16_RSFT16(a, b) \
    (((uint32_t) (uint16_t)(a) * (uint16_t)(b)) >> 16)
#define VOIP_SPL_UMUL_32_16(a, b) \
    ((uint32_t) ((uint32_t)(a) * (uint16_t)(b)))
#define VOIP_SPL_UMUL_32_16_RSFT16(a, b) \
    ((uint32_t) ((uint32_t)(a) * (uint16_t)(b)) >> 16)
#define VOIP_SPL_MUL_16_U16(a, b) \
    ((int32_t)(int16_t)(a) * (uint16_t)(b))
#define VOIP_SPL_DIV(a, b) \
    ((int32_t) ((int32_t)(a) / (int32_t)(b)))
#define VOIP_SPL_UDIV(a, b) \
    ((uint32_t) ((uint32_t)(a) / (uint32_t)(b)))

#ifndef VOIP_ARCH_ARM_V7
// For ARMv7 platforms, these are inline functions in spl_inl_armv7.h
#ifndef MIPS32_LE
// For MIPS platforms, these are inline functions in spl_inl_mips.h
#define VOIP_SPL_MUL_16_16(a, b) \
    ((int32_t) (((int16_t)(a)) * ((int16_t)(b))))
#define VOIP_SPL_MUL_16_32_RSFT16(a, b) \
    (VOIP_SPL_MUL_16_16(a, b >> 16) \
     + ((VOIP_SPL_MUL_16_16(a, (b & 0xffff) >> 1) + 0x4000) >> 15))
#define VOIP_SPL_MUL_32_32_RSFT32(a32a, a32b, b32) \
    ((int32_t)(VOIP_SPL_MUL_16_32_RSFT16(a32a, b32) \
    + (VOIP_SPL_MUL_16_32_RSFT16(a32b, b32) >> 16)))
#define VOIP_SPL_MUL_32_32_RSFT32BI(a32, b32) \
    ((int32_t)(VOIP_SPL_MUL_16_32_RSFT16(( \
    (int16_t)(a32 >> 16)), b32) + \
    (VOIP_SPL_MUL_16_32_RSFT16(( \
    (int16_t)((a32 & 0x0000FFFF) >> 1)), b32) >> 15)))
#endif
#endif

#define VOIP_SPL_MUL_16_32_RSFT11(a, b) \
    ((VOIP_SPL_MUL_16_16(a, (b) >> 16) << 5) \
    + (((VOIP_SPL_MUL_16_U16(a, (uint16_t)(b)) >> 1) + 0x0200) >> 10))
#define VOIP_SPL_MUL_16_32_RSFT14(a, b) \
    ((VOIP_SPL_MUL_16_16(a, (b) >> 16) << 2) \
    + (((VOIP_SPL_MUL_16_U16(a, (uint16_t)(b)) >> 1) + 0x1000) >> 13))
#define VOIP_SPL_MUL_16_32_RSFT15(a, b) \
    ((VOIP_SPL_MUL_16_16(a, (b) >> 16) << 1) \
    + (((VOIP_SPL_MUL_16_U16(a, (uint16_t)(b)) >> 1) + 0x2000) >> 14))

#define VOIP_SPL_MUL_16_16_RSFT(a, b, c) \
    (VOIP_SPL_MUL_16_16(a, b) >> (c))

#define VOIP_SPL_MUL_16_16_RSFT_WITH_ROUND(a, b, c) \
    ((VOIP_SPL_MUL_16_16(a, b) + ((int32_t) \
                                  (((int32_t)1) << ((c) - 1)))) >> (c))
#define VOIP_SPL_MUL_16_16_RSFT_WITH_FIXROUND(a, b) \
    ((VOIP_SPL_MUL_16_16(a, b) + ((int32_t) (1 << 14))) >> 15)

// C + the 32 most significant bits of A * B
#define VOIP_SPL_SCALEDIFF32(A, B, C) \
    (C + (B >> 16) * A + (((uint32_t)(0x0000FFFF & B) * A) >> 16))

#define VOIP_SPL_ADD_SAT_W32(a, b)    VoipSpl_AddSatW32(a, b)
#define VOIP_SPL_SAT(a, b, c)         (b > a ? a : b < c ? c : b)
#define VOIP_SPL_MUL_32_16(a, b)      ((a) * (b))

#define VOIP_SPL_SUB_SAT_W32(a, b)    VoipSpl_SubSatW32(a, b)
#define VOIP_SPL_ADD_SAT_W16(a, b)    VoipSpl_AddSatW16(a, b)
#define VOIP_SPL_SUB_SAT_W16(a, b)    VoipSpl_SubSatW16(a, b)

// We cannot do casting here due to signed/unsigned problem
#define VOIP_SPL_IS_NEG(a)            ((a) & 0x80000000)
// Shifting with negative numbers allowed
// Positive means left shift
#define VOIP_SPL_SHIFT_W16(x, c) \
    (((c) >= 0) ? ((x) << (c)) : ((x) >> (-(c))))
#define VOIP_SPL_SHIFT_W32(x, c) \
    (((c) >= 0) ? ((x) << (c)) : ((x) >> (-(c))))

// Shifting with negative numbers not allowed
// We cannot do casting here due to signed/unsigned problem
#define VOIP_SPL_RSHIFT_W16(x, c)     ((x) >> (c))
#define VOIP_SPL_LSHIFT_W16(x, c)     ((x) << (c))
#define VOIP_SPL_RSHIFT_W32(x, c)     ((x) >> (c))
#define VOIP_SPL_LSHIFT_W32(x, c)     ((x) << (c))

#define VOIP_SPL_RSHIFT_U16(x, c)     ((uint16_t)(x) >> (c))
#define VOIP_SPL_LSHIFT_U16(x, c)     ((uint16_t)(x) << (c))
#define VOIP_SPL_RSHIFT_U32(x, c)     ((uint32_t)(x) >> (c))
#define VOIP_SPL_LSHIFT_U32(x, c)     ((uint32_t)(x) << (c))

#define VOIP_SPL_RAND(a) \
    ((int16_t)(VOIP_SPL_MUL_16_16_RSFT((a), 18816, 7) & 0x00007fff))

#ifdef __cplusplus
extern "C" {
#endif

#define VOIP_SPL_MEMCPY_W8(v1, v2, length) \
  memcpy(v1, v2, (length) * sizeof(char))
#define VOIP_SPL_MEMCPY_W16(v1, v2, length) \
  memcpy(v1, v2, (length) * sizeof(int16_t))

#define VOIP_SPL_MEMMOVE_W16(v1, v2, length) \
  memmove(v1, v2, (length) * sizeof(int16_t))

// inline functions:
#include "audio_engine/common_audio/signal_processing/include/spl_inl.h"

// Initialize SPL. Currently it contains only function pointer initialization.
// If the underlying platform is known to be ARM-Neon (VOIP_ARCH_ARM_NEON
// defined), the pointers will be assigned to code optimized for Neon; otherwise
// if run-time Neon detection (VOIP_DETECT_ARM_NEON) is enabled, the pointers
...
int VoipSpl_GetScalingSquare(int16_t* in_vector,
                               int in_vector_length,
                               int times);

// Copy and set operations. Implementation in copy_set_operations.c.
// Descriptions at bottom of file.
void VoipSpl_MemSetW16(int16_t* vector,
                         int16_t set_value,
                         int vector_length);
void VoipSpl_MemSetW32(int32_t* vector,
                         int32_t set_value,
                         int vector_length);
void VoipSpl_MemCpyReversedOrder(int16_t* out_vector,
                                   int16_t* in_vector,
                                   int vector_length);
int16_t VoipSpl_CopyFromEndW16(const int16_t* in_vector,
                                 int16_t in_vector_length,
                                 int16_t samples,
                                 int16_t* out_vector);
int16_t VoipSpl_ZerosArrayW16(int16_t* vector,
                                int16_t vector_length);
int16_t VoipSpl_ZerosArrayW32(int32_t* vector,
                                int16_t vector_length);
int16_t VoipSpl_OnesArrayW16(int16_t* vector,
                               int16_t vector_length);
int16_t VoipSpl_OnesArrayW32(int32_t* vector,
                               int16_t vector_length);
...
extern MaxAbsValueW16 VoipSpl_MaxAbsValueW16;
...
int16_t VoipSpl_MaxAbsValueW16Neon(const int16_t* vector, int length);
#endif
#if defined(MIPS32_LE)
int16_t VoipSpl_MaxAbsValueW16_mips(const int16_t* vector, int length);
#endif
...
extern MaxAbsValueW32 VoipSpl_MaxAbsValueW32;
int32_t VoipSpl_MaxAbsValueW32C(const int32_t* vector, int length);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
int32_t VoipSpl_MaxAbsValueW32Neon(const int32_t* vector, int length);
#endif
#if defined(MIPS_DSP_R1_LE)
int32_t VoipSpl_MaxAbsValueW32_mips(const int32_t* vector, int length);
#endif
...
//                 If (vector == NULL || length <= 0) VOIP_SPL_WORD16_MIN
//                 is returned. Note that VOIP_SPL_WORD16_MIN is a feasible
//                 value and we can't catch errors purely based on it.
typedef int16_t (*MaxValueW16)(const int16_t* vector, int length);
extern MaxValueW16 VoipSpl_MaxValueW16;
int16_t VoipSpl_MaxValueW16C(const int16_t* vector, int length);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
int16_t VoipSpl_MaxValueW16Neon(const int16_t* vector, int length);
#endif
#if defined(MIPS32_LE)
int16_t VoipSpl_MaxValueW16_mips(const int16_t* vector, int length);
#endif
...
//
// Return value  : Maximum sample value in |vector|.
//                 If (vector == NULL || length <= 0) VOIP_SPL_WORD32_MIN
//                 is returned. Note that VOIP_SPL_WORD32_MIN is a feasible
//                 value and we can't catch errors purely based on it.
typedef int32_t (*MaxValueW32)(const int32_t* vector, int length);
extern MaxValueW32 VoipSpl_MaxValueW32;
int32_t VoipSpl_MaxValueW32C(const int32_t* vector, int length);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
int32_t VoipSpl_MaxValueW32Neon(const int32_t* vector, int length);
#endif
#if defined(MIPS32_LE)
int32_t VoipSpl_MaxValueW32_mips(const int32_t* vector, int length);
#endif
...
//                 If (vector == NULL || length <= 0) VOIP_SPL_WORD16_MAX
//                 is returned. Note that VOIP_SPL_WORD16_MAX is a feasible
//                 value and we can't catch errors purely based on it.
typedef int16_t (*MinValueW16)(const int16_t* vector, int length);
extern MinValueW16 VoipSpl_MinValueW16;
int16_t VoipSpl_MinValueW16C(const int16_t* vector, int length);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
int16_t VoipSpl_MinValueW16Neon(const int16_t* vector, int length);
#endif
#if defined(MIPS32_LE)
int16_t VoipSpl_MinValueW16_mips(const int16_t* vector, int length);
#endif
...
//
// Return value  : Minimum sample value in |vector|.
//                 If (vector == NULL || length <= 0) VOIP_SPL_WORD32_MAX
//                 is returned. Note that VOIP_SPL_WORD32_MAX is a feasible
//                 value and we can't catch errors purely based on it.
typedef int32_t (*MinValueW32)(const int32_t* vector, int length);
extern MinValueW32 VoipSpl_MinValueW32;
int32_t VoipSpl_MinValueW32C(const int32_t* vector, int length);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
int32_t VoipSpl_MinValueW32Neon(const int32_t* vector, int length);
#endif
#if defined(MIPS32_LE)
int32_t VoipSpl_MinValueW32_mips(const int32_t* vector, int length);
#endif
...
void VoipSpl_VectorBitShiftW16(int16_t* out_vector,
                                 int16_t vector_length,
...
void VoipSpl_VectorBitShiftW32(int32_t* out_vector,
                                 ...
                                 int16_t right_shifts);
void VoipSpl_VectorBitShiftW32ToW16(int16_t* out_vector,
                                      int vector_length,
                                      const int32_t* in_vector,
                                      int right_shifts);
void VoipSpl_ScaleVector(const int16_t* in_vector,
                           int16_t* out_vector,
                           int16_t gain,
                           int16_t vector_length,
                           int16_t right_shifts);
void VoipSpl_ScaleVectorWithSat(const int16_t* in_vector,
                                  int16_t* out_vector,
                                  int16_t gain,
                                  int16_t vector_length,
                                  int16_t right_shifts);
void VoipSpl_ScaleAndAddVectors(const int16_t* in_vector1,
...
typedef int (*ScaleAndAddVectorsWithRound)(const int16_t* in_vector1,
                                           ...
                                           int16_t* out_vector,
                                           int length);
extern ScaleAndAddVectorsWithRound VoipSpl_ScaleAndAddVectorsWithRound;
int VoipSpl_ScaleAndAddVectorsWithRoundC(const int16_t* in_vector1,
                                           ...
                                           int length);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
int VoipSpl_ScaleAndAddVectorsWithRoundNeon(const int16_t* in_vector1,
                                              int16_t in_vector1_scale,
                                              const int16_t* in_vector2,
                                              int16_t in_vector2_scale,
                                              int right_shifts,
...
#endif
#if defined(MIPS_DSP_R1_LE)
int VoipSpl_ScaleAndAddVectorsWithRound_mips(const int16_t* in_vector1,
                                               int16_t in_vector1_scale,
                                               const int16_t* in_vector2,
                                               int16_t in_vector2_scale,
                                               int right_shifts,
...
// Description at bottom of file.
void VoipSpl_ReverseOrderMultArrayElements(int16_t* out_vector,
                                             const int16_t* in_vector,
                                             const int16_t* window,
                                             int16_t vector_length,
                                             int16_t right_shifts);
void VoipSpl_ElementwiseVectorMult(int16_t* out_vector,
                                     const int16_t* in_vector,
                                     const int16_t* window,
                                     int16_t vector_length,
                                     int16_t right_shifts);
void VoipSpl_AddVectorsAndShift(int16_t* out_vector,
                                  const int16_t* in_vector1,
                                  const int16_t* in_vector2,
                                  int16_t vector_length,
                                  int16_t right_shifts);
void VoipSpl_AddAffineVectorToVector(int16_t* out_vector,
                                       int16_t* in_vector,
                                       int16_t gain,
                                       int32_t add_constant,
                                       int16_t right_shifts,
                                       int vector_length);
void VoipSpl_AffineTransformVector(int16_t* out_vector,
                                     int16_t* in_vector,
                                     int16_t gain,
                                     int32_t add_constant,
                                     int16_t right_shifts,
...
int VoipSpl_AutoCorrelation(const int16_t* in_vector,
                              int in_vector_length,
                              int order,
                              int32_t* result,
                              int* scale);
...
int16_t VoipSpl_LevinsonDurbin(int32_t* auto_corr,
                                 int16_t* lpc_coef,
                                 int16_t* refl_coef,
                                 int16_t order);
...
void VoipSpl_ReflCoefToLpc(const int16_t* refl_coef,
                             int use_order,
                             int16_t* lpc_coef);
...
void VoipSpl_LpcToReflCoef(int16_t* lpc_coef,
                             int use_order,
                             int16_t* refl_coef);
...
// Output:
//      - refl_coef : Reflection coefficients in Q15.
void VoipSpl_AutoCorrToReflCoef(const int32_t* auto_corr,
                                  int use_order,
                                  int16_t* refl_coef);
...
typedef void (*CrossCorrelation)(int32_t* cross_correlation,
                                 ...
                                 int16_t right_shifts,
                                 int16_t step_seq2);
extern CrossCorrelation VoipSpl_CrossCorrelation;
void VoipSpl_CrossCorrelationC(int32_t* cross_correlation,
                                 const int16_t* seq1,
                                 const int16_t* seq2,
                                 int16_t dim_seq,
                                 int16_t dim_cross_correlation,
                                 ...
                                 int16_t step_seq2);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
void VoipSpl_CrossCorrelationNeon(int32_t* cross_correlation,
                                    const int16_t* seq1,
                                    const int16_t* seq2,
                                    int16_t dim_seq,
                                    int16_t dim_cross_correlation,
...
#endif
#if defined(MIPS32_LE)
void VoipSpl_CrossCorrelation_mips(int32_t* cross_correlation,
                                     const int16_t* seq1,
                                     const int16_t* seq2,
                                     int16_t dim_seq,
                                     int16_t dim_cross_correlation,
...
void VoipSpl_GetHanningWindow(int16_t* window, int16_t size);
...
void VoipSpl_SqrtOfOneMinusXSquared(int16_t* in_vector,
                                      int vector_length,
                                      int16_t* out_vector);
...
uint32_t VoipSpl_IncreaseSeed(uint32_t* seed);
int16_t VoipSpl_RandU(uint32_t* seed);
int16_t VoipSpl_RandN(uint32_t* seed);
int16_t VoipSpl_RandUArray(int16_t* vector,
                             int16_t vector_length,
                             uint32_t* seed);
// End: Randomization functions.

// Math functions
int32_t VoipSpl_Sqrt(int32_t value);
int32_t VoipSpl_SqrtFloor(int32_t value);

// Divisions. Implementations collected in division_operations.c and
// descriptions at bottom of this file.
uint32_t VoipSpl_DivU32U16(uint32_t num, uint16_t den);
int32_t VoipSpl_DivW32W16(int32_t num, int16_t den);
int16_t VoipSpl_DivW32W16ResW16(int32_t num, int16_t den);
int32_t VoipSpl_DivResultInQ31(int32_t num, int32_t den);
int32_t VoipSpl_DivW32HiLow(int32_t num, int16_t den_hi, int16_t den_low);
// End: Divisions.
...
int32_t VoipSpl_DotProductWithScale(const int16_t* vector1,
                                      const int16_t* vector2,
                                      int length,
                                      int scaling);

// Filter operations.
int VoipSpl_FilterAR(const int16_t* ar_coef,
                       int ar_coef_length,
                       const int16_t* in_vector,
                       int in_vector_length,
...
void VoipSpl_FilterMAFastQ12(int16_t* in_vector,
                               int16_t* out_vector,
                               int16_t* ma_coef,
...
typedef int (*DownsampleFast)(const int16_t* data_in,
                              ...
                              int factor,
                              int delay);
extern DownsampleFast VoipSpl_DownsampleFast;
int VoipSpl_DownsampleFastC(const int16_t* data_in,
                              ...
                              int delay);
#if (defined VOIP_DETECT_ARM_NEON) || (defined VOIP_ARCH_ARM_NEON)
int VoipSpl_DownsampleFastNeon(const int16_t* data_in,
                                 int data_in_length,
                                 int16_t* data_out,
                                 int data_out_length,
                                 const int16_t* __restrict coefficients,
...
#endif
#if defined(MIPS32_LE)
int VoipSpl_DownsampleFast_mips(const int16_t* data_in,
                                  int data_in_length,
                                  int16_t* data_out,
                                  int data_out_length,
                                  const int16_t* __restrict coefficients,
...
int VoipSpl_ComplexFFT(int16_t vector[], int stages, int mode);
int VoipSpl_ComplexIFFT(int16_t vector[], int stages, int mode);
...
//                        10, since the table VoIPSpl_kSinTable1024[] is 1024
//                        elements long.
//
// Output:
//      - complex_data  : The complex data buffer.

void VoipSpl_ComplexBitReverse(int16_t* __restrict complex_data, int stages);
...
typedef struct {
  ...
  int32_t S_44_32[8];
  int32_t S_32_16[8];
} VoipSpl_State22khzTo16khz;

void VoipSpl_Resample22khzTo16khz(const int16_t* in,
                                    int16_t* out,
                                    VoipSpl_State22khzTo16khz* state,
                                    int32_t* tmpmem);

void VoipSpl_ResetResample22khzTo16khz(VoipSpl_State22khzTo16khz* state);

// state structure for 16 -> 22 resampler
typedef struct {
  int32_t S_16_32[8];
  int32_t S_32_22[8];
} VoipSpl_State16khzTo22khz;

void VoipSpl_Resample16khzTo22khz(const int16_t* in,
                                    int16_t* out,
                                    VoipSpl_State16khzTo22khz* state,
                                    int32_t* tmpmem);

void VoipSpl_ResetResample16khzTo22khz(VoipSpl_State16khzTo22khz* state);
...
typedef struct {
  ...
  int32_t S_22_16[8];
  int32_t S_16_8[8];
} VoipSpl_State22khzTo8khz;

void VoipSpl_Resample22khzTo8khz(const int16_t* in, int16_t* out,
                                   VoipSpl_State22khzTo8khz* state,
                                   int32_t* tmpmem);

void VoipSpl_ResetResample22khzTo8khz(VoipSpl_State22khzTo8khz* state);
...
typedef struct {
  ...
  int32_t S_16_11[8];
  int32_t S_11_22[8];
} VoipSpl_State8khzTo22khz;

void VoipSpl_Resample8khzTo22khz(const int16_t* in, int16_t* out,
                                   VoipSpl_State8khzTo22khz* state,
                                   int32_t* tmpmem);

void VoipSpl_ResetResample8khzTo22khz(VoipSpl_State8khzTo22khz* state);
...
void VoipSpl_Resample48khzTo32khz(const int32_t* In, int32_t* Out,
                                    int32_t K);

void VoipSpl_Resample32khzTo24khz(const int32_t* In, int32_t* Out,
                                    int32_t K);

void VoipSpl_Resample44khzTo32khz(const int32_t* In, int32_t* Out,
                                    int32_t K);
...
typedef struct {
  ...
  int32_t S_48_32[8];
  int32_t S_32_16[8];
} VoipSpl_State48khzTo16khz;

void VoipSpl_Resample48khzTo16khz(const int16_t* in, int16_t* out,
                                    VoipSpl_State48khzTo16khz* state,
                                    int32_t* tmpmem);

void VoipSpl_ResetResample48khzTo16khz(VoipSpl_State48khzTo16khz* state);

typedef struct {
  int32_t S_16_32[8];
  int32_t S_32_24[8];
  int32_t S_24_48[8];
} VoipSpl_State16khzTo48khz;

void VoipSpl_Resample16khzTo48khz(const int16_t* in, int16_t* out,
                                    VoipSpl_State16khzTo48khz* state,
                                    int32_t* tmpmem);

void VoipSpl_ResetResample16khzTo48khz(VoipSpl_State16khzTo48khz* state);
...
typedef struct {
  ...
  int32_t S_24_16[8];
  int32_t S_16_8[8];
} VoipSpl_State48khzTo8khz;

void VoipSpl_Resample48khzTo8khz(const int16_t* in, int16_t* out,
                                   VoipSpl_State48khzTo8khz* state,
                                   int32_t* tmpmem);

void VoipSpl_ResetResample48khzTo8khz(VoipSpl_State48khzTo8khz* state);
...
typedef struct {
  ...
  int32_t S_12_24[8];
  int32_t S_24_48[8];
} VoipSpl_State8khzTo48khz;

void VoipSpl_Resample8khzTo48khz(const int16_t* in, int16_t* out,
                                   VoipSpl_State8khzTo48khz* state,
                                   int32_t* tmpmem);

void VoipSpl_ResetResample8khzTo48khz(VoipSpl_State8khzTo48khz* state);
...
void VoipSpl_DownsampleBy2(const int16_t* in, int16_t len,
                             int16_t* out, int32_t* filtState);

void VoipSpl_UpsampleBy2(const int16_t* in, int16_t len,
                           int16_t* out, int32_t* filtState);

/************************************************************
 * END OF RESAMPLING FUNCTIONS
 ************************************************************/
void VoipSpl_AnalysisQMF(const int16_t* in_data,
                           int in_data_length,
                           int16_t* low_band,
                           int16_t* high_band,
                           int32_t* filter_state1,
                           int32_t* filter_state2);
void VoipSpl_SynthesisQMF(const int16_t* low_band,
...
#endif  // __cplusplus
#endif  // VOIP_SPL_SIGNAL_PROCESSING_LIBRARY_H_
...
//
// VoIPSpl_VectorBitShiftW16(...)
// VoIPSpl_VectorBitShiftW32(...)
//
...
//
// VoIPSpl_VectorBitShiftW32ToW16(...)
//
...
//                    since the table VoIPSpl_kSinTable1024[] is 1024
//                    elements long.
//
