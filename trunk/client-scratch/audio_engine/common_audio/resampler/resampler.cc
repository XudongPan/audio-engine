...
int Resampler::Reset(int inFreq, int outFreq, ResamplerType type)
{
    ...
    switch (my_mode_)
    {
        ...
        case kResamplerMode1To3:
            state1_ = malloc(sizeof(VoipSpl_State16khzTo48khz));
            VoipSpl_ResetResample16khzTo48khz((VoipSpl_State16khzTo48khz *)state1_);
            break;
        ...
        case kResamplerMode1To6:
            ...
            memset(state1_, 0, 8 * sizeof(int32_t));
            // 2:6
            state2_ = malloc(sizeof(VoipSpl_State16khzTo48khz));
            VoipSpl_ResetResample16khzTo48khz((VoipSpl_State16khzTo48khz *)state2_);
            break;
        case kResamplerMode1To12:
            ...
            memset(state2_, 0, 8 * sizeof(int32_t));
            // 4:12
            state3_ = malloc(sizeof(VoipSpl_State16khzTo48khz));
            VoipSpl_ResetResample16khzTo48khz(
                (VoipSpl_State16khzTo48khz*) state3_);
            break;
        ...
        case kResamplerMode2To11:
            ...
            state2_ = malloc(sizeof(VoipSpl_State8khzTo22khz));
            VoipSpl_ResetResample8khzTo22khz((VoipSpl_State8khzTo22khz *)state2_);
            break;
        case kResamplerMode4To11:
            state1_ = malloc(sizeof(VoipSpl_State8khzTo22khz));
            VoipSpl_ResetResample8khzTo22khz((VoipSpl_State8khzTo22khz *)state1_);
            break;
        case kResamplerMode8To11:
            state1_ = malloc(sizeof(VoipSpl_State16khzTo22khz));
            VoipSpl_ResetResample16khzTo22khz((VoipSpl_State16khzTo22khz *)state1_);
            break;
        case kResamplerMode11To16:
            state1_ = malloc(8 * sizeof(int32_t));
            memset(state1_, 0, 8 * sizeof(int32_t));

            state2_ = malloc(sizeof(VoipSpl_State22khzTo16khz));
            VoipSpl_ResetResample22khzTo16khz((VoipSpl_State22khzTo16khz *)state2_);
            break;
        ...
        case kResamplerMode3To1:
            state1_ = malloc(sizeof(VoipSpl_State48khzTo16khz));
            VoipSpl_ResetResample48khzTo16khz((VoipSpl_State48khzTo16khz *)state1_);
            break;
        ...
        case kResamplerMode12To1:
            // 12:4
            state1_ = malloc(sizeof(VoipSpl_State48khzTo16khz));
            VoipSpl_ResetResample48khzTo16khz(
                (VoipSpl_State48khzTo16khz*) state1_);
            // 4:2
            state2_ = malloc(8 * sizeof(int32_t));
            memset(state2_, 0, 8 * sizeof(int32_t));
            // 2:1
        ...
        case kResamplerMode3To2:
            ...
            memset(state1_, 0, 8 * sizeof(int32_t));
            // 6:2
            state2_ = malloc(sizeof(VoipSpl_State48khzTo16khz));
            VoipSpl_ResetResample48khzTo16khz((VoipSpl_State48khzTo16khz *)state2_);
            break;
        case kResamplerMode11To2:
            state1_ = malloc(sizeof(VoipSpl_State22khzTo8khz));
            VoipSpl_ResetResample22khzTo8khz((VoipSpl_State22khzTo8khz *)state1_);
        ...
        case kResamplerMode11To8:
            state1_ = malloc(sizeof(VoipSpl_State22khzTo16khz));
            VoipSpl_ResetResample22khzTo16khz((VoipSpl_State22khzTo16khz *)state1_);
            break;
                    ...
                    int maxLen, int &outLen)
{
    ...
    switch (my_mode_)
    {
        ...
        case kResamplerMode1To2:
            ...
            VoipSpl_UpsampleBy2(samplesIn, lengthIn, samplesOut, (int32_t*)state1_);
            outLen = lengthIn * 2;
            return 0;
        case kResamplerMode1To3:
            ...
            {
                VoipSpl_Resample16khzTo48khz(samplesIn + i, samplesOut + i * 3,
                                               (VoipSpl_State16khzTo48khz *)state1_,
                                               tmp_mem);
            }
            outLen = lengthIn * 3;
            free(tmp_mem);
        ...
        case kResamplerMode1To4:
            ...
            // 1:2
            VoipSpl_UpsampleBy2(samplesIn, lengthIn, tmp, (int32_t*)state1_);
            // 2:4
            VoipSpl_UpsampleBy2(tmp, lengthIn * 2, samplesOut, (int32_t*)state2_);
            outLen = lengthIn * 4;
            free(tmp);
            return 0;
        case kResamplerMode1To6:
            ...
            {
                VoipSpl_Resample16khzTo48khz(tmp + i, samplesOut + i * 3,
                                               (VoipSpl_State16khzTo48khz *)state2_,
                                               tmp_mem);
            }
            outLen = outLen * 3;
            free(tmp_mem);
        ...
        case kResamplerMode1To12:
            ...
            //1:2
            VoipSpl_UpsampleBy2(samplesIn, lengthIn, samplesOut,
                                  (int32_t*) state1_);
            outLen = lengthIn * 2;
            //2:4
            VoipSpl_UpsampleBy2(samplesOut, outLen, tmp, (int32_t*) state2_);
            outLen = outLen * 2;
            // 4:12
            for (int i = 0; i < outLen; i += 160) {
              // VoIPSpl_Resample16khzTo48khz() takes a block of 160 samples
        ...
        case kResamplerMode2To3:
            ...
            for (int i = 0; i < lengthIn; i += 160)
            {
                VoipSpl_Resample16khzTo48khz(samplesIn + i, tmp + i * 3,
                                               (VoipSpl_State16khzTo48khz *)state1_,
                                               tmp_mem);
            }
            lengthIn = lengthIn * 3;
            // 6:3
            VoipSpl_DownsampleBy2(tmp, lengthIn, samplesOut, (int32_t*)state2_);
            outLen = lengthIn / 2;
            free(tmp);
            free(tmp_mem);
            return 0;
        case kResamplerMode2To11:
            ...
            {
                VoipSpl_Resample8khzTo22khz(tmp + i, samplesOut + (i * 11) / 4,
                                              (VoipSpl_State8khzTo22khz *)state2_,
                                              tmp_mem);
            }
        ...
        case kResamplerMode4To11:
            ...
            for (int i = 0; i < lengthIn; i += 80)
            {
                VoipSpl_Resample8khzTo22khz(samplesIn + i, samplesOut + (i * 11) / 4,
                                              (VoipSpl_State8khzTo22khz *)state1_,
                                              tmp_mem);
            }
            outLen = (lengthIn * 11) / 4;
            free(tmp_mem);
        ...
        case kResamplerMode8To11:
            ...
            for (int i = 0; i < lengthIn; i += 160)
            {
                VoipSpl_Resample16khzTo22khz(samplesIn + i, samplesOut + (i * 11) / 8,
                                               (VoipSpl_State16khzTo22khz *)state1_,
                                               tmp_mem);
            }
        ...
        case kResamplerMode11To16:
            ...
            {
                VoipSpl_Resample22khzTo16khz(tmp + i, samplesOut + (i / 220) * 160,
                                               (VoipSpl_State22khzTo16khz *)state2_,
                                               tmp_mem);
            }
        ...
        case kResamplerMode11To32:
            ...
            for (int i = 0; i < (lengthIn * 2); i += 220)
            {
                VoipSpl_Resample22khzTo16khz(samplesOut + i, tmp + (i / 220) * 160,
                                               (VoipSpl_State22khzTo16khz *)state2_,
                                               tmp_mem);
            }

            // 16 -> 32 in samplesOut
            VoipSpl_UpsampleBy2(tmp, (lengthIn * 16) / 11, samplesOut,
                                  (int32_t*)state3_);
        ...
        case kResamplerMode2To1:
            ...
            VoipSpl_DownsampleBy2(samplesIn, lengthIn, samplesOut, (int32_t*)state1_);
            outLen = lengthIn / 2;
            return 0;
        case kResamplerMode3To1:
            ...
            {
                VoipSpl_Resample48khzTo16khz(samplesIn + i, samplesOut + i / 3,
                                               (VoipSpl_State48khzTo16khz *)state1_,
                                               tmp_mem);
            }
            outLen = lengthIn / 3;
        ...
        case kResamplerMode4To1:
            ...
            tmp = (int16_t*)malloc(sizeof(int16_t) * lengthIn / 2);
            // 4:2
            VoipSpl_DownsampleBy2(samplesIn, lengthIn, tmp, (int32_t*)state1_);
            // 2:1
            VoipSpl_DownsampleBy2(tmp, lengthIn / 2, samplesOut, (int32_t*)state2_);
            outLen = lengthIn / 4;
            free(tmp);
            return 0;
        ...
        case kResamplerMode6To1:
            ...
            for (int i = 0; i < lengthIn; i += 480)
            {
                VoipSpl_Resample48khzTo16khz(samplesIn + i, tmp + i / 3,
                                               (VoipSpl_State48khzTo16khz *)state1_,
                                               tmp_mem);
            }
            outLen = lengthIn / 3;
            free(tmp_mem);
            VoipSpl_DownsampleBy2(tmp, outLen, samplesOut, (int32_t*)state2_);
            free(tmp);
            outLen = outLen / 2;
            return 0;
        case kResamplerMode12To1:
            ...
            // 12:4
            for (int i = 0; i < lengthIn; i += 480) {
              // VoIPSpl_Resample48khzTo16khz() takes a block of 480 samples
            ...
            free(tmp_mem);
            // 4:2
            VoipSpl_DownsampleBy2(tmp, outLen, tmp_2,
                                    (int32_t*) state2_);
            outLen = outLen / 2;
            free(tmp);
            // 2:1
            VoipSpl_DownsampleBy2(tmp_2, outLen, samplesOut,
                                    (int32_t*) state3_);
            free(tmp_2);
            outLen = outLen / 2;
            return 0;
        case kResamplerMode3To2:
            ...
            for (int i = 0; i < lengthIn; i += 480)
            {
                VoipSpl_Resample48khzTo16khz(tmp + i, samplesOut + i / 3,
                                               (VoipSpl_State48khzTo16khz *)state2_,
                                               tmp_mem);
            }
            outLen = lengthIn / 3;
            free(tmp);
        ...
        case kResamplerMode11To2:
            ...
            {
                VoipSpl_Resample22khzTo8khz(samplesIn + i, tmp + (i * 4) / 11,
                                              (VoipSpl_State22khzTo8khz *)state1_,
                                              tmp_mem);
            }
        ...
        case kResamplerMode11To4:
            ...
            for (int i = 0; i < lengthIn; i += 220)
            {
                VoipSpl_Resample22khzTo8khz(samplesIn + i, samplesOut + (i * 4) / 11,
                                              (VoipSpl_State22khzTo8khz *)state1_,
                                              tmp_mem);
            }
        ...
        case kResamplerMode11To8:
            ...
            for (int i = 0; i < lengthIn; i += 220)
            {
                VoipSpl_Resample22khzTo16khz(samplesIn + i, samplesOut + (i * 8) / 11,
                                               (VoipSpl_State22khzTo16khz *)state1_,
                                               tmp_mem);
            }
