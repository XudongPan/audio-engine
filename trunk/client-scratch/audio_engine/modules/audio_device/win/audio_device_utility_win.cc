...
#include "audio_engine/modules/audio_device/win/audio_device_utility_win.h"
...
int32_t AudioDeviceUtilityWindows::Init()
{
    ...
    if (GetOSDisplayString(szOS))
    {
        ...
        VOIP_TRACE(kTraceStateInfo, kTraceAudioDevice, _id, "  OS info: %s", os);
#else
        VOIP_TRACE(kTraceStateInfo, kTraceAudioDevice, _id, "  OS info: %s", szOS);
#endif
    }
