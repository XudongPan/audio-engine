#ifndef VOIP_MODULES_AUDIO_PROCESSING_AGC_INCLUDE_GAIN_CONTROL_H_
#define VOIP_MODULES_AUDIO_PROCESSING_AGC_INCLUDE_GAIN_CONTROL_H_
 ...
 *                          : -1 - Error
 */
int VoipAgc_AddFarend(void* agcInst,
                        const int16_t* inFar,
                        int16_t samples);
 ...
 *                          : -1 - Error
 */
int VoipAgc_AddMic(void* agcInst,
                     int16_t* inMic,
                     int16_t* inMic_H,
                     int16_t samples);
 ...
 *                          : -1 - Error
 */
int VoipAgc_VirtualMic(void* agcInst,
                         int16_t* inMic,
                         int16_t* inMic_H,
                         int16_t samples,
                         int32_t micLevelIn,
 ...
 *                          : -1 - Error
 */
int VoipAgc_Process(void* agcInst,
 ...
 *                          : -1 - Error
 */
int VoipAgc_set_config(void* agcInst, VoipAgc_config_t config);
...
#endif  // VOIP_MODULES_AUDIO_PROCESSING_AGC_INCLUDE_GAIN_CONTROL_H_
