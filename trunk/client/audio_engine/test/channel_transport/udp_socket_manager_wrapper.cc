...
#include "audio_engine/test/channel_transport/udp_socket_manager_wrapper.h"

#include <assert.h>

#ifdef _WIN32
#include "audio_engine/system_wrappers/interface/fix_interlocked_exchange_pointer_win.h"
#include "audio_engine/test/channel_transport/udp_socket2_manager_win.h"
#else
#include "audio_engine/test/channel_transport/udp_socket_manager_posix.h"
#endif
