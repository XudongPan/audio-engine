...
// VoERTPObserver
class VOIP_DLLEXPORT VoERTPObserver
{
public:
...
// VoERTCPObserver
class VOIP_DLLEXPORT VoERTCPObserver
{
public:
...
// VoERTP_RTCP
class VOIP_DLLEXPORT VoERTP_RTCP
{
public:
    ...
    static VoERTP_RTCP* GetInterface(AudioEngine* voiceEngine);
