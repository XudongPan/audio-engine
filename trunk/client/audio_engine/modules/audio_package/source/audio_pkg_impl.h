...
class ModuleRtpRtcpImpl : public RtpRtcp {
 public:
  ...
  virtual int32_t CSRCs(uint32_t arr_of_csrc[kCsrcSize]) const OVERRIDE;

  virtual int32_t SetCSRCs(const uint32_t arr_of_csrc[kCsrcSize],
  ...
  // (XR) VoIP metric.
  virtual int32_t SetRTCPVoIPMetrics(const RTCPVoIPMetric* webrtcMetric) OVERRIDE;
