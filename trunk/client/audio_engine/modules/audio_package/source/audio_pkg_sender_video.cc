...
#include "audio_engine/modules/audio_package/source/audio_pkg_format_video_generic.h"
#include "audio_engine/modules/audio_package/source/audio_pkg_format_vp8.h"
                        ...
                        const RTPVideoTypeHeader* rtpTypeHdr)
{
    ...
    TRACE_EVENT_ASYNC_END1("VoIP", "Video", capture_time_ms,
