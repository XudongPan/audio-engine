...
#include "audio_engine/modules/audio_package/source/audio_ctrl_pkg_receiver.h"
...
#include "audio_engine/modules/audio_package/source/audio_ctrl_pkg_utility.h"
#include "audio_engine/modules/audio_package/source/audio_pkg_impl.h"
...
#include "audio_engine/system_wrappers/interface/trace_event.h"
                                 ...
                                 RTCPUtility::RTCPParserV2* rtcpParser)
{
    ...
    while (pktType != RTCPUtility::kRtcpNotValidCode)
    {
        ...
        case RTCPUtility::kRtcpXrDlrrReportBlockCode:
            ...
            break;
        case RTCPUtility::kRtcpXrwebrtcMetricCode:
            HandleXRwebrtcMetric(*rtcpParser, rtcpPacketInformation);
            break;
...
// no need for critsect we have _criticalSectionRTCPReceiver
void
RTCPReceiver::HandleXRwebrtcMetric(RTCPUtility::RTCPParserV2& rtcpParser,
                                 RTCPPacketInformation& rtcpPacketInformation)
{
    const RTCPUtility::RTCPPacket& rtcpPacket = rtcpParser.Packet();
    ...
    if(rtcpPacket.XRwebrtcMetricItem.SSRC == main_ssrc_)
    {
        ...
        receivedVoIPMetrics.burstDensity = rtcpPacket.XRwebrtcMetricItem.burstDensity;
        receivedVoIPMetrics.burstDuration = rtcpPacket.XRwebrtcMetricItem.burstDuration;
        receivedVoIPMetrics.discardRate = rtcpPacket.XRwebrtcMetricItem.discardRate;
        receivedVoIPMetrics.endSystemDelay = rtcpPacket.XRwebrtcMetricItem.endSystemDelay;
        receivedVoIPMetrics.extRfactor = rtcpPacket.XRwebrtcMetricItem.extRfactor;
        receivedVoIPMetrics.gapDensity = rtcpPacket.XRwebrtcMetricItem.gapDensity;
        receivedVoIPMetrics.gapDuration = rtcpPacket.XRwebrtcMetricItem.gapDuration;
        receivedVoIPMetrics.Gmin = rtcpPacket.XRwebrtcMetricItem.Gmin;
        receivedVoIPMetrics.JBabsMax = rtcpPacket.XRwebrtcMetricItem.JBabsMax;
        receivedVoIPMetrics.JBmax = rtcpPacket.XRwebrtcMetricItem.JBmax;
        receivedVoIPMetrics.JBnominal = rtcpPacket.XRwebrtcMetricItem.JBnominal;
        receivedVoIPMetrics.lossRate = rtcpPacket.XRwebrtcMetricItem.lossRate;
        receivedVoIPMetrics.MOSCQ = rtcpPacket.XRwebrtcMetricItem.MOSCQ;
        receivedVoIPMetrics.MOSLQ = rtcpPacket.XRwebrtcMetricItem.MOSLQ;
        receivedVoIPMetrics.noiseLevel = rtcpPacket.XRwebrtcMetricItem.noiseLevel;
        receivedVoIPMetrics.RERL = rtcpPacket.XRwebrtcMetricItem.RERL;
        receivedVoIPMetrics.Rfactor = rtcpPacket.XRwebrtcMetricItem.Rfactor;
        receivedVoIPMetrics.roundTripDelay = rtcpPacket.XRwebrtcMetricItem.roundTripDelay;
        receivedVoIPMetrics.RXconfig = rtcpPacket.XRwebrtcMetricItem.RXconfig;
        receivedVoIPMetrics.signalLevel = rtcpPacket.XRwebrtcMetricItem.signalLevel;

        rtcpPacketInformation.AddVoIPMetric(&receivedVoIPMetrics);

        rtcpPacketInformation.rtcpPacketTypeFlags |= kRtcpXrwebrtcMetric; // received signal
    }
    rtcpParser.Iterate();
}
...
void RTCPReceiver::TriggerCallbacksFromRTCPPacket(
  ...
  }
  {
    ...
    if(_cbRtcpFeedback) {
      ...
      if(rtcpPacketInformation.rtcpPacketTypeFlags & kRtcpXrwebrtcMetric) {
        _cbRtcpFeedback->OnXRwebrtcMetricReceived(_id,
