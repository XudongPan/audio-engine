...
#include "audio_engine/modules/remote_bitrate_estimator/include/bwe_defines.h"
...
#include "audio_engine/modules/audio_package/source/tmmbr_help.h"
...
public:
 struct FeedbackState {
    ...
    */
    ...
    int32_t SetCSRCs(const uint32_t arrOfCSRC[kCsrcSize],
