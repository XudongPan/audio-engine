...
bool RTCPUtility::RTCPParserV2::ParseXrItem() {
  ...
  switch (block_type) {
    ...
    case kBtwebrtcMetric:
      return ParseXrwebrtcMetricItem(block_length_in_4bytes);
    default:
...
bool RTCPUtility::RTCPParserV2::ParseXrwebrtcMetricItem(int block_length_4bytes) {
  ...
  _packet.XRwebrtcMetricItem.SSRC = *_ptrRTCPData++ << 24;
  _packet.XRwebrtcMetricItem.SSRC += *_ptrRTCPData++ << 16;
  _packet.XRwebrtcMetricItem.SSRC += *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.SSRC += *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.lossRate = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.discardRate = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.burstDensity = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.gapDensity = *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.burstDuration = *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.burstDuration += *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.gapDuration = *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.gapDuration += *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.roundTripDelay = *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.roundTripDelay += *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.endSystemDelay = *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.endSystemDelay += *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.signalLevel = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.noiseLevel = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.RERL = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.Gmin = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.Rfactor = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.extRfactor = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.MOSLQ = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.MOSCQ = *_ptrRTCPData++;
  _packet.XRwebrtcMetricItem.RXconfig = *_ptrRTCPData++;
  _ptrRTCPData++; // skip reserved

  _packet.XRwebrtcMetricItem.JBnominal = *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.JBnominal += *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.JBmax = *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.JBmax += *_ptrRTCPData++;

  _packet.XRwebrtcMetricItem.JBabsMax = *_ptrRTCPData++ << 8;
  _packet.XRwebrtcMetricItem.JBabsMax += *_ptrRTCPData++;

  _packetType = kRtcpXrwebrtcMetricCode;
  _state = State_XRItem;
  return true;
}
