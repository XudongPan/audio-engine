...
#include "audio_engine/modules/audio_coding/main/source/acm_codec_database.h"

#include "audio_engine/modules/audio_coding/main/acm2/acm_common_defs.h"
#include "audio_engine/system_wrappers/interface/trace.h"

// Includes needed to create the codecs.
// G.711, PCM mu-law and A-law.
#include "audio_engine/modules/audio_coding/codecs/g711/include/g711_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_pcma.h"
#include "audio_engine/modules/audio_coding/main/source/acm_pcmu.h"
// CNG.
#include "audio_engine/modules/audio_coding/codecs/cng/include/webrtc_cng.h"
#include "audio_engine/modules/audio_coding/main/source/acm_cng.h"
// NetEQ.
#include "audio_engine/modules/audio_coding/neteq/interface/webrtc_neteq.h"
#ifdef WEBRTC_CODEC_ISAC
#include "audio_engine/modules/audio_coding/codecs/isac/main/interface/isac.h"
#endif
#ifdef WEBRTC_CODEC_ISACFX
#include "audio_engine/modules/audio_coding/codecs/isac/fix/interface/isacfix.h"
#endif
#if (defined(WEBRTC_CODEC_ISAC) || defined(WEBRTC_CODEC_ISACFX))
#include "audio_engine/modules/audio_coding/main/source/acm_isac.h"
#include "audio_engine/modules/audio_coding/main/source/acm_isac_macros.h"
#endif
#ifdef VOIP_CODEC_PCM16
#include "audio_engine/modules/audio_coding/codecs/pcm16b/include/pcm16b.h"
#include "audio_engine/modules/audio_coding/main/source/acm_pcm16b.h"
#endif
#ifdef WEBRTC_CODEC_ILBC
#include "audio_engine/modules/audio_coding/codecs/ilbc/interface/ilbc.h"
#include "audio_engine/modules/audio_coding/main/source/acm_ilbc.h"
#endif
#ifdef WEBRTC_CODEC_AMR
#include "audio_engine/modules/audio_coding/codecs/amr/include/amr_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_amr.h"
#endif
#ifdef WEBRTC_CODEC_AMRWB
#include "audio_engine/modules/audio_coding/codecs/amrwb/include/amrwb_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_amrwb.h"
#endif
#ifdef WEBRTC_CODEC_CELT
#include "audio_engine/modules/audio_coding/codecs/celt/include/celt_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_celt.h"
#endif
#ifdef WEBRTC_CODEC_G722
#include "audio_engine/modules/audio_coding/codecs/g722/include/g722_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_g722.h"
#endif
#ifdef WEBRTC_CODEC_G722_1
#include "audio_engine/modules/audio_coding/codecs/g7221/include/g7221_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_g7221.h"
#endif
#ifdef WEBRTC_CODEC_G722_1C
#include "audio_engine/modules/audio_coding/codecs/g7221c/include/g7221c_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_g7221c.h"
#endif
#ifdef WEBRTC_CODEC_G729
#include "audio_engine/modules/audio_coding/codecs/g729/include/g729_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_g729.h"
#endif
#ifdef WEBRTC_CODEC_G729_1
#include "audio_engine/modules/audio_coding/codecs/g7291/include/g7291_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_g7291.h"
#endif
#ifdef WEBRTC_CODEC_GSMFR
#include "audio_engine/modules/audio_coding/codecs/gsmfr/include/gsmfr_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_gsmfr.h"
#endif
#ifdef WEBRTC_CODEC_OPUS
#include "audio_engine/modules/audio_coding/codecs/opus/interface/opus_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_opus.h"
#endif
#ifdef WEBRTC_CODEC_SPEEX
#include "audio_engine/modules/audio_coding/codecs/speex/include/speex_interface.h"
#include "audio_engine/modules/audio_coding/main/source/acm_speex.h"
#endif
#ifdef WEBRTC_CODEC_AVT
#include "audio_engine/modules/audio_coding/main/source/acm_dtmf_playout.h"
#endif
#ifdef WEBRTC_CODEC_RED
#include "audio_engine/modules/audio_coding/main/source/acm_red.h"
#endif
...
int ACMCodecDB::CodecNumber(const CodecInst* codec_inst, int* mirror_id) {
  ...
  if (codec_settings_[codec_id].num_packet_sizes > 0) {
    ...
    for (i = 0; i < codec_settings_[codec_id].num_packet_sizes; i++) {
      ...
      if (codec_inst->packsize == packet_size_samples) {
        packet_size_ok = true;
        break;
      }
    }
  ...
  *mirror_id = codec_id;
  if (STR_CASE_CMP("isac", codec_inst->plname) == 0) {
    ...
    return IsILBCRateValid(codec_inst->rate, codec_inst->packsize)
