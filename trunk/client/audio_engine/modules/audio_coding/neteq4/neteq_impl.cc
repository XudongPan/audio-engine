...
#include "audio_engine/modules/audio_coding/neteq4/background_noise.h"
#include "audio_engine/modules/audio_coding/neteq4/buffer_level_filter.h"
#include "audio_engine/modules/audio_coding/neteq4/comfort_noise.h"
#include "audio_engine/modules/audio_coding/neteq4/decision_logic.h"
#include "audio_engine/modules/audio_coding/neteq4/decoder_database.h"
#include "audio_engine/modules/audio_coding/neteq4/defines.h"
...
#include "audio_engine/modules/audio_coding/neteq4/merge.h"
#include "audio_engine/modules/audio_coding/neteq4/normal.h"
#include "audio_engine/modules/audio_coding/neteq4/packet_buffer.h"
#include "audio_engine/modules/audio_coding/neteq4/packet.h"
#include "audio_engine/modules/audio_coding/neteq4/payload_splitter.h"
#include "audio_engine/modules/audio_coding/neteq4/post_decode_vad.h"
#include "audio_engine/modules/audio_coding/neteq4/preemptive_expand.h"
#include "audio_engine/modules/audio_coding/neteq4/sync_buffer.h"
...
int NetEqImpl::InsertPacketInternal(const WebRtcRTPHeader& rtp_header,
  ...
  if (update_sample_rate_and_channels && !packet_buffer_->Empty()) {
    ...
    const AudioPacketHeader* rtp_header = packet_buffer_->NextRtpHeader();
    assert(rtp_header);
...
int NetEqImpl::GetDecision(Operations* operation,
  ...
  *operation = kUndefined;
  ...
  const AudioPacketHeader* header = packet_buffer_->NextRtpHeader();
...
int NetEqImpl::DoDtmf(const DtmfEvent& dtmf_event, bool* play_dtmf) {
  ...
  //
  // See http://VoIP-codereview.appspot.com/1195004/ for discussion
