#ifndef VOIP_SYSTEM_WRAPPERS_INTERFACE_STATIC_INSTANCE_H_
#define VOIP_SYSTEM_WRAPPERS_INTERFACE_STATIC_INSTANCE_H_
...
#endif  // VOIP_SYSTEM_WRAPPERS_INTERFACE_STATIC_INSTANCE_H_
