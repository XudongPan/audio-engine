#include "audio_engine/system_wrappers/source/rw_lock_win.h"
...
bool RWLockWin::LoadModule() {
  ...
  VOIP_TRACE(kTraceStateInfo, kTraceUtility, -1, "Loaded Kernel.dll");
  ...
  if (initialize_srw_lock && acquire_srw_lock_exclusive &&
      ...
      release_srw_lock_shared) {
    VOIP_TRACE(kTraceStateInfo, kTraceUtility, -1, "Loaded Native RW Lock");
