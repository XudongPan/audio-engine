#ifndef VOIP_MODULES_AUDIO_PROCESSING_INCLUDE_AUDIO_PROCESSING_H_
#define VOIP_MODULES_AUDIO_PROCESSING_INCLUDE_AUDIO_PROCESSING_H_
...
//   sufficiently unreliable. See VOIP_UNTRUSTED_DELAY in echo_cancellation.c.
...
class GainControl {
 public:
  ...
  //
  // TODO(ajm): use a negative value here instead, if/when AoE will similarly
...
#endif  // VOIP_MODULES_AUDIO_PROCESSING_INCLUDE_AUDIO_PROCESSING_H_
