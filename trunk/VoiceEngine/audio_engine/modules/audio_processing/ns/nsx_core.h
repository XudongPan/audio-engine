#ifndef VOIP_MODULES_AUDIO_PROCESSING_NS_MAIN_SOURCE_NSX_CORE_H_
#define VOIP_MODULES_AUDIO_PROCESSING_NS_MAIN_SOURCE_NSX_CORE_H_
...
#endif  // VOIP_MODULES_AUDIO_PROCESSING_NS_MAIN_SOURCE_NSX_CORE_H_
