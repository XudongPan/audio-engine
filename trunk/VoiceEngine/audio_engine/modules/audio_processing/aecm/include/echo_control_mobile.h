#ifndef VOIP_MODULES_AUDIO_PROCESSING_AECM_INCLUDE_ECHO_CONTROL_MOBILE_H_
#define VOIP_MODULES_AUDIO_PROCESSING_AECM_INCLUDE_ECHO_CONTROL_MOBILE_H_
 ...
 * initialized separately using the VoipAecm_Init() function.
 *
 * Inputs                           Description
 * -------------------------------------------------------------------
...
/*
 * This function releases the memory allocated by VoipAecm_Create()
 *
 * Inputs                       Description
 * -------------------------------------------------------------------
 ...
 *                             -1: error
 */
int32_t VoipAecm_BufferFarend(void* aecmInst,
 ...
 *                             -1: error
 */
int32_t VoipAecm_Process(void* aecmInst,
...
#endif
#endif  // VOIP_MODULES_AUDIO_PROCESSING_AECM_INCLUDE_ECHO_CONTROL_MOBILE_H_
