...
Audio_Device_FuncTest::Audio_Device_FuncTest() :
    _processThread(NULL),
    _audioDevice(NULL),
    _audioEventObserver(NULL),
    _audioTransport(NULL)
{
//   _playoutFile48 = VOIP::test::ResourcePath("audio_device\\audio_short48",
//                                               "pcm");
//   _playoutFile44 = VOIP::test::ResourcePath("audio_device\\audio_short44",
//                                               "pcm");
//   _playoutFile16 = VOIP::test::ResourcePath("audio_device\\audio_short16",
//                                               "pcm");
//   _playoutFile8 = VOIP::test::ResourcePath("audio_device\\audio_short8",
//                                              "pcm");
}
...
int32_t Audio_Device_FuncTest::Init()
{
...
int32_t Audio_Device_FuncTest::Close()
{
...
int32_t Audio_Device_FuncTest::DoTest(const TestType testType)
{
    switch (testType)
    {
        case TTAll:
...
int32_t Audio_Device_FuncTest::TestAudioLayerSelection()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestDeviceEnumeration()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestDeviceSelection()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestAudioTransport()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestSpeakerVolume()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestSpeakerMute()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestMicrophoneVolume()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestMicrophoneMute()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestMicrophoneBoost()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestMicrophoneAGC()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestLoopback()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestDeviceRemoval()
{
    TEST_LOG("\n=======================================\n");
...
int32_t Audio_Device_FuncTest::TestExtra()
{
    TEST_LOG("\n=======================================\n");
    TEST_LOG(" Extra test:\n");
    TEST_LOG("=======================================\n");
...
int32_t Audio_Device_FuncTest::SelectRecordingDevice()
{
...
int32_t Audio_Device_FuncTest::SelectPlayoutDevice()
{
...
int32_t Audio_Device_FuncTest::TestAdvancedMBAPI()
{
    TEST_LOG("\n=======================================\n");
...
#if defined(_WIN32_WCE) || defined(VOIP_IOS)
    TEST_LOG("\nResetAudioDevice\n \n");
    if (audioDevice->Recording() && audioDevice->Playing())
    {
