#ifndef VOIP_AUDIO_DEVICE_AUDIO_DEVICE_DEFINES_H
#define VOIP_AUDIO_DEVICE_AUDIO_DEVICE_DEFINES_H
...
public:
    ...
    // |channel_ids| contains a list of AoE channels which are the
    ...
    // Currently VoIP supports only one APM, and Chrome will make sure only
    ...
    // Method to pass the captured audio data to the specific AoE channel.
    // |voe_channel| is the id of the AoE channel which is the sink to the
    // capture data.
    ...
    // Method to push the captured audio data to the specific AoE channel.
    ...
    // Method to pull mixed render audio data from all active AoE channels.
    // The data will not be passed as reference for audio processing internally.
    // TODO(xians): Support getting the unmixed render data from specific AoE
    // channel.
...
#endif  // VOIP_AUDIO_DEVICE_AUDIO_DEVICE_DEFINES_H
