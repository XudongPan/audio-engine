...
#include "audio_engine/modules/audio_coding/neteq4/decision_logic_fax.h"
#include "audio_engine/modules/audio_coding/neteq4/decision_logic_normal.h"
...
Operations DecisionLogic::GetDecision(const SyncBuffer& sync_buffer,
                                      ...
                                      const AudioPacketHeader* packet_header,
                                      Modes prev_mode,
