...
#if (defined(WEBRTC_LINUX) || defined(VOIP_ANDROID))
      pid_(-1),
#endif
      attr_(),
      thread_(0) {
...
#if defined(VOIP_ANDROID) || defined(WEBRTC_LINUX)
  return static_cast<uint32_t>(syscall(__NR_gettid));
#elif defined(WEBRTC_MAC) || defined(VOIP_IOS)
...
#define HAS_THREAD_ID !defined(VOIP_IOS) && !defined(WEBRTC_MAC)
