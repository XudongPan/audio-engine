...
#include "audio_engine/modules/remote_bitrate_estimator/rate_statistics.h"
#include "audio_engine/modules/remote_bitrate_estimator/include/remote_bitrate_estimator.h"
#include "audio_engine/modules/remote_bitrate_estimator/overuse_detector.h"
#include "audio_engine/modules/remote_bitrate_estimator/remote_rate_control.h"
...
class RemoteBitrateEstimatorSingleStream : public RemoteBitrateEstimator {
 public:
  ...
  virtual void IncomingPacket(int64_t arrival_time_ms,
                              int payload_size,
                              const AudioPacketHeader& header) OVERRIDE;
