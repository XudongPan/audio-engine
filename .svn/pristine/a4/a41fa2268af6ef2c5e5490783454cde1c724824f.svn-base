...
#include "audio_engine/test/channel_transport/udp_socket_wrapper.h"
...
#if defined(_WIN32)
    #include "audio_engine/test/channel_transport/udp_socket2_win.h"
#else
    #include "audio_engine/test/channel_transport/udp_socket_posix.h"
#endif
