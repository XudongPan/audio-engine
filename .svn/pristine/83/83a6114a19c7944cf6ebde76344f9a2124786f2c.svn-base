#ifndef VOIP_MODULES_AUDIO_PROCESSING_AGC_MAIN_SOURCE_DIGITAL_AGC_H_
#define VOIP_MODULES_AUDIO_PROCESSING_AGC_MAIN_SOURCE_DIGITAL_AGC_H_
...
int32_t VoipAgc_InitDigital(DigitalAgc_t *digitalAgcInst, int16_t agcMode);

int32_t VoipAgc_ProcessDigital(DigitalAgc_t *digitalAgcInst,
                                 const int16_t *inNear, const int16_t *inNear_H,
                                 int16_t *out, int16_t *out_H, uint32_t FS,
                                 int16_t lowLevelSignal);

int32_t VoipAgc_AddFarendToDigital(DigitalAgc_t *digitalAgcInst,
                                     const int16_t *inFar,
                                     int16_t nrSamples);

void VoipAgc_InitVad(AgcVad_t *vadInst);

int16_t VoipAgc_ProcessVad(AgcVad_t *vadInst, // (i) VAD state
...
#endif // VOIP_MODULES_AUDIO_PROCESSING_AGC_MAIN_SOURCE_DIGITAL_AGC_H_
