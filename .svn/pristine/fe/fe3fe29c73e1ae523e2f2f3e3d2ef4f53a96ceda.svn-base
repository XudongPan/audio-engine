#ifndef VOIP_SYSTEM_WRAPPERS_INTERFACE_THREAD_WRAPPER_H_
#define VOIP_SYSTEM_WRAPPERS_INTERFACE_THREAD_WRAPPER_H_
...
#endif  // VOIP_SYSTEM_WRAPPERS_INTERFACE_THREAD_WRAPPER_H_
