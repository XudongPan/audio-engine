#ifndef VOIP_SYSTEM_WRAPPERS_INTERFACE_TRACE_EVENT_H_
#define VOIP_SYSTEM_WRAPPERS_INTERFACE_TRACE_EVENT_H_

#include <string>

#include "audio_engine/system_wrappers/interface/event_tracer.h"
...
#define TRACE_STR_COPY(str) \
    VoIP::trace_event_internal::TraceStringWithCopy(str)

// By default, uint64 ID argument values are not mangled with the Process ID in
// TRACE_EVENT_ASYNC macros. Use this macro to force Process ID mangling.
#define TRACE_ID_MANGLE(id) \
    VoIP::trace_event_internal::TraceID::ForceMangle(id)
...
#define TRACE_EVENT_API_GET_CATEGORY_ENABLED \
    VoIP::EventTracer::GetCategoryEnabled
...
//                    unsigned char flags)
#define TRACE_EVENT_API_ADD_TRACE_EVENT VoIP::EventTracer::AddTraceEvent
...
#define INTERNAL_TRACE_EVENT_ADD(phase, category, name, flags, ...) \
    do { \
      ...
      if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
        VoIP::trace_event_internal::AddTraceEvent(          \
            phase, INTERNAL_TRACE_EVENT_UID(catstatic), name, \
            VoIP::trace_event_internal::kNoEventId, flags, ##__VA_ARGS__); \
      } \
    } while (0)
...
#define INTERNAL_TRACE_EVENT_ADD_SCOPED(category, name, ...) \
    INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO(category); \
    VoIP::trace_event_internal::TraceEndOnScopeClose  \
        INTERNAL_TRACE_EVENT_UID(profileScope); \
    if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
      VoIP::trace_event_internal::AddTraceEvent(      \
          TRACE_EVENT_PHASE_BEGIN, \
          INTERNAL_TRACE_EVENT_UID(catstatic), \
          name, VoIP::trace_event_internal::kNoEventId,       \
...
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID(phase, category, name, id, flags, \
    ...
    do { \
      ...
      if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
        ...
        VoIP::trace_event_internal::TraceID trace_event_trace_id( \
...
#endif  // VOIP_SYSTEM_WRAPPERS_INTERFACE_TRACE_EVENT_H_
