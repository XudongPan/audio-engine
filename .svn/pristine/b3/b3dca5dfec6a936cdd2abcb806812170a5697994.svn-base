...
#include "audio_engine/modules/pacing/include/paced_sender.h"
...
#include "audio_engine/modules/audio_package/source/audio_pkg_header_extension.h"
#include "audio_engine/modules/audio_package/source/audio_pkg_history.h"
#include "audio_engine/modules/audio_package/source/audio_pkg_config.h"
#include "audio_engine/modules/audio_package/source/ssrc_database.h"
...
class RTPSender : public RTPSenderInterface, public Bitrate::Observer {
 public:
  ...
  int32_t CSRCs(uint32_t arr_of_csrc[kCsrcSize]) const;

  void SetCSRCStatus(const bool include);

  void SetCSRCs(const uint32_t arr_of_csrc[kCsrcSize],
 ...
 private:
  ...
  void UpdateRtpStats(const uint8_t* buffer,
                      ...
                      bool is_rtx,
                      bool is_retransmit);
  bool IsFecPacket(const uint8_t* buffer, const AudioPacketHeader& header) const;
