...
#include "audio_engine/modules/audio_package/source/receive_statistics_impl.h"
...
void StreamStatisticianImpl::IncomingPacket(const AudioPacketHeader& header,
                                            size_t bytes,
                                            bool retransmitted) {
...
void StreamStatisticianImpl::UpdateCounters(const AudioPacketHeader& header,
                                            size_t bytes,
                                            bool retransmitted) {
  CriticalSectionScoped cs(stream_lock_.get());
...
void StreamStatisticianImpl::UpdateJitter(const AudioPacketHeader& header,
                                          uint32_t receive_time_secs,
                                          uint32_t receive_time_frac) {
...
bool StreamStatisticianImpl::IsRetransmitOfOldPacket(
    const AudioPacketHeader& header, int min_rtt) const {
  CriticalSectionScoped cs(stream_lock_.get());
...
void ReceiveStatisticsImpl::IncomingPacket(const AudioPacketHeader& header,
                                           size_t bytes,
                                           bool retransmitted) {
...
void NullReceiveStatistics::IncomingPacket(const AudioPacketHeader& rtp_header,
                                           size_t bytes,
                                           bool retransmitted) {}
