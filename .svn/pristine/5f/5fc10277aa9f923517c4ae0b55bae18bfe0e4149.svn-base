#ifndef VOIP_COMMON_AUDIO_RESAMPLER_INCLUDE_PUSH_RESAMPLER_H_
#define VOIP_COMMON_AUDIO_RESAMPLER_INCLUDE_PUSH_RESAMPLER_H_
...
#endif  // VOIP_COMMON_AUDIO_RESAMPLER_INCLUDE_PUSH_RESAMPLER_H_
