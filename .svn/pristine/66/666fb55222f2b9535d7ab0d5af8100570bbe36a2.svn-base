...
int16_t ACMILBC::InternalInitEncoder(WebRtcACMCodecParams* codec_params) {
  ...
  if ((160 == (codec_params->codec_inst).packsize) ||
      (320 == (codec_params->codec_inst).packsize)) {
    // processing block of 20ms
    return WebRtcIlbcfix_EncoderInit(encoder_inst_ptr_, 20);
  } else if ((240 == (codec_params->codec_inst).packsize) ||
      (480 == (codec_params->codec_inst).packsize)) {
