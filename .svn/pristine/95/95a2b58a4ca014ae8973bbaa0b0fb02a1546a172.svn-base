...
#include "audio_engine/modules/audio_coding/main/acm2/acm_receiver.h"
...
int AcmReceiver::InsertPacket(const WebRtcRTPHeader& rtp_header,
  ...
  const AudioPacketHeader* header = &rtp_header.header;  // Just a shorthand.
...
int AcmReceiver::RtpHeaderToCodecIndex(
    const AudioPacketHeader &rtp_header, const uint8_t* payload) const {
