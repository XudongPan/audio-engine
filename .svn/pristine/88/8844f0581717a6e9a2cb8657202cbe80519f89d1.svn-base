...
#ifndef VOIP_MODULES_MEDIA_FILE_SOURCE_MEDIA_FILE_UTILITY_H_
#define VOIP_MODULES_MEDIA_FILE_SOURCE_MEDIA_FILE_UTILITY_H_
...
#endif // VOIP_MODULES_MEDIA_FILE_SOURCE_MEDIA_FILE_UTILITY_H_
