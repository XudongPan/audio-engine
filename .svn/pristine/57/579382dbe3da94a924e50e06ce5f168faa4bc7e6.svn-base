...
/*
 * This file contains the function VoIPSpl_FilterAR().
...
int VoipSpl_FilterAR(const int16_t* a,
                       int a_length,
                       const int16_t* x,
                       int x_length,
                       int16_t* state,
                       ...
                       int filtered_low_length)
{
    ...
    for (i = 0; i < x_length; i++)
    {
        ...
        for (j = 1; j < stop; j++)
        {
            o -= VOIP_SPL_MUL_16_16(*a_ptr, *filtered_ptr--);
            oLOW -= VOIP_SPL_MUL_16_16(*a_ptr++, *filtered_low_ptr--);
        }
        for (j = i + 1; j < a_length; j++)
        {
            o -= VOIP_SPL_MUL_16_16(*a_ptr, *state_ptr--);
            oLOW -= VOIP_SPL_MUL_16_16(*a_ptr++, *state_low_ptr--);
        }
    ...
    {
        VoipSpl_CopyFromEndW16(filtered, x_length, a_length - 1, state);
        VoipSpl_CopyFromEndW16(filtered_low, x_length, a_length - 1, state_low);
    } else
    {
