...
VoERTP_RTCP* VoERTP_RTCP::GetInterface(AudioEngine* voiceEngine)
{
...
int VoERTP_RTCPImpl::StopRTPDump(int channel, AudioPacketDirections direction)
{
    WEBRTC_TRACE(kTraceApiCall, kTraceVoice, VoEId(_shared->instance_id(), -1),
...
int VoERTP_RTCPImpl::RTPDumpIsActive(int channel, AudioPacketDirections direction)
{
    WEBRTC_TRACE(kTraceApiCall, kTraceVoice, VoEId(_shared->instance_id(), -1),
