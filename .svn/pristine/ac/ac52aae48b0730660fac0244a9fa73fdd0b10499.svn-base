...
class RTPPayloadRegistry {
 public:
  ...
  bool IsRtx(const AudioPacketHeader& header) const;
  ...
  bool IsRed(const AudioPacketHeader& header) const;

  // Returns true if the media of this RTP packet is encapsulated within an
  // extra header, such as RTX or RED.
  bool IsEncapsulated(const AudioPacketHeader& header) const;
  ...
  void SetIncomingPayloadType(const AudioPacketHeader& header);
 ...
 private:
  ...
  bool IsRtxInternal(const AudioPacketHeader& header) const;
