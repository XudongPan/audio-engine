...
int32_t VoipSpl_SqrtFloor(int32_t value)
{
  ...
  VOIP_SPL_SQRT_ITER (15);
  VOIP_SPL_SQRT_ITER (14);
  VOIP_SPL_SQRT_ITER (13);
  VOIP_SPL_SQRT_ITER (12);
  VOIP_SPL_SQRT_ITER (11);
  VOIP_SPL_SQRT_ITER (10);
  VOIP_SPL_SQRT_ITER ( 9);
  VOIP_SPL_SQRT_ITER ( 8);
  VOIP_SPL_SQRT_ITER ( 7);
  VOIP_SPL_SQRT_ITER ( 6);
  VOIP_SPL_SQRT_ITER ( 5);
  VOIP_SPL_SQRT_ITER ( 4);
  VOIP_SPL_SQRT_ITER ( 3);
  VOIP_SPL_SQRT_ITER ( 2);
  VOIP_SPL_SQRT_ITER ( 1);
  VOIP_SPL_SQRT_ITER ( 0);
