...
#ifndef VOIP_MODULES_AUDIO_PROCESSING_UTILITY_RING_BUFFER_H_
#define VOIP_MODULES_AUDIO_PROCESSING_UTILITY_RING_BUFFER_H_
...
int Voip_InitBuffer(RingBuffer* handle);
...
// guaranteed to be valid until the next call to VoIP_WriteBuffer().
//
// To force a copying to |data|, pass a NULL |data_ptr|.
//
// Returns number of elements read.
size_t Voip_ReadBuffer(RingBuffer* handle,
                         void** data_ptr,
                         void* data,
                         size_t element_count);

// Writes |data| to buffer and returns the number of elements written.
size_t Voip_WriteBuffer(RingBuffer* handle, const void* data,
                          size_t element_count);
...
int Voip_MoveReadPtr(RingBuffer* handle, int element_count);

// Returns number of available elements to read.
size_t Voip_available_read(const RingBuffer* handle);

// Returns number of available elements for write.
size_t Voip_available_write(const RingBuffer* handle);

#endif  // VOIP_MODULES_AUDIO_PROCESSING_UTILITY_RING_BUFFER_H_
